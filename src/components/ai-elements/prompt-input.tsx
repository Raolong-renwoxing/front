...
export const PromptInputActionAddAttachments = ({
  ...
  return (
    <DropdownMenuItem {...props} onSelect={handleSelect as (event: React.SyntheticEvent) => void}>
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleSelect = useCallback(
    async (event: unknown) => {
      (onSelect as unknown as (e: Event) => void)?.(event as Event);
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (e: unknown) => {
      ...
      (onClick as (e: React.MouseEvent<HTMLButtonElement>) => void)?.(mouseEvent);
    },
  ...
  return (
    <InputGroupButton
      ...
      className={cn(className)}
      onClick={handleClick as (event: React.MouseEvent<HTMLButtonElement>) => void}
      size={size}
