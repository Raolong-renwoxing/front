...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === "user" ? "is-user ml-auto items-end max-w-[75%] sm:max-w-[65%]" : "is-assistant items-start max-w-full",
      className
    )}
    {...props}
  />
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-assistant]:text-foreground group-[.is-assistant]:px-0",
      className
    )}
    {...props}
  >
